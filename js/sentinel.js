...
function capture( sketchfab_api, img_type = 'image/png', initial_camera, frame_index, total_frames = 1047, width = 1920, height = 1080 ) {
    ...
    camera_promise.then( function( new_camera ) {
        ...
        capture( sketchfab_api, img_type, initial_camera, frame_index + 1, total_frames, width, height );
    });
}
